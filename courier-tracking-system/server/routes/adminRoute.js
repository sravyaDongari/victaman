...
// Example tracking data (replace with actual data from the database)
const trackingData = [
...
const isAdmin = (req, res, next) => {
  ...
  const isAdminUser = true; // Replace this with your admin check logic
...
router.post('/', verifyToken, isAdmin, (req, res) => {
  // Implement logic to add tracking information
  ...
  res.json({ message: 'Tracking information added successfully', trackingInfo: newTracking });
});

// Route to update tracking information (admin privilege required)
...
// Route to delete tracking information (admin privilege required)
